...
END
    ...
    const double k = 10.0*Opm::prefix::milli * Opm::unit::darcy;
    const double h = 20;
    const double rw = 0.108;
...

    {
        ...
        BOOST_CHECK_MESSAGE(!wdfac11.useConnectionDFactor(),
                            R"(Well "W1" must NOT use connection D-Factors at report step 1)");

        BOOST_CHECK_MESSAGE(wdfac11.useDFactor(),
                            R"(Well "W1" must use D-Factors at report step 1)");

        BOOST_CHECK_MESSAGE(!wdfac21.useConnectionDFactor(),
                            R"(Well "W2" must NOT use connection D-Factors at report step 1)");

        BOOST_CHECK_CLOSE(wdfac11.getDFactor(rho, mu, k, phi, rw, h), 1.0*dFacUnit, 1e-12);
        BOOST_CHECK_CLOSE(wdfac21.getDFactor(rho, mu, k, phi, rw, h), 2.0*dFacUnit, 1e-12);
    }

    {
        ...
        BOOST_CHECK_CLOSE(wdfac22.getDFactor(rho, mu, k, phi, rw, h), 2.0*dFacUnit, 1e-12);
    }

    {
        ...
        BOOST_CHECK_MESSAGE(wdfac13.useConnectionDFactor(),
                            R"(Well "W1" must use connection D-Factor at report step 3)");

        BOOST_CHECK_MESSAGE(wdfac13.useDFactor(),
                            R"(Well "W1" must use D-Factor at report step 3)");

        BOOST_CHECK_MESSAGE(!wdfac23.useConnectionDFactor(),
                            R"(Well "W2" must NOT use connection D-Factors at report step 3)");
        ...
        BOOST_CHECK_CLOSE(wdfac23.getDFactor(rho, mu, k, phi, rw, h), 2.0*dFacUnit, 1e-12);
